...
public class ModScreenHandlers {
    public static final ScreenHandlerType<OvenScreenHandler> OVEN_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "oven_screen"),
    ...
    public static final ScreenHandlerType<FreezerScreenHandler> FREEZER_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "freezing_screen"),
    ...
    public static final ScreenHandlerType<AdvanceFurnaceScreenHandler> ADVANCE_FURNACE_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "advance_furnace_screen"),
    ...
    public static final ScreenHandlerType<WoodenBasinScreenHandler> WOODEN_BASIN_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "wooden_basin_screen"),
    ...
    public static final ScreenHandlerType<GasCanisterScreenHandler> GAS_CANISTER_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "gas_canister_screen"),
    ...
    public static final ScreenHandlerType<BiogasDigesterControllerScreenHandler> BIOGAS_DIGESTER_CONTROLLER_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "biogas_digester_controller_screen"),
    ...
    public static final ScreenHandlerType<BiogasDigesterIOScreenHandler> BIOGAS_DIGESTER_IO_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "biogas_digester_io_screen"),
    ...
    public static final ScreenHandlerType<DeepFryerScreenHandler> DEEP_FRYER_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "deep_fryer_screen"),
    ...
    public static final ScreenHandlerType<CuisineTableScreenHandler> CUISINE_TABLE_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "cuisine_table_screen"),
    ...
    public static final ScreenHandlerType<CabinetScreenHandler> CABINET_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "cabinet_screen"),
    ...
    public static final ScreenHandlerType<PhotovoltaicGeneratorScreenHandler> PHOTOVOLTAIC_GENERATOR_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "photovoltaic_generator_screen"),
    ...
    public static final ScreenHandlerType<ACDCConverterScreenHandler> ACDC_CONVERTER_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "ac_dc_converter_screen"),
    ...
    public static final ScreenHandlerType<WindTurbineControllerScreenHandler> WIND_TURBINE_CONTROLLER_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "wind_turbine_controller_screen"),
    ...
    public static final ScreenHandlerType<FaradayGeneratorScreenHandler> FARADAY_GENERATOR_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "faraday_generator_screen"),
    ...
    public static final ScreenHandlerType<TeslaCoilScreenHandler> TESLA_COIL_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "tesla_coil_screen"),
    ...
    public static final ScreenHandlerType<ElectriciansDeskScreenHandler> ELECTRICIANS_DESK_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "electric_desk_screen"),
    ...
    public static final ScreenHandlerType<BambooSteamerScreenHandler> BAMBOO_STEAMER_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "bamboo_steamer_screen"),
    ...
    public static final ScreenHandlerType<ElectricSteamerScreenHandler> ELECTRIC_STEAMER_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "electric_steamer_screen"),
    ...
    public static final ScreenHandlerType<IceCreamMakerScreenHandler> ICE_CREAM_MAKER_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "ice_cream_maker_screen"),
    ...
    public static final ScreenHandlerType<ChargingPostScreenHandler> CHARGING_POST_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(ModernDelightMain.MOD_ID, "charging_post_screen"),
