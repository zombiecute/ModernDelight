...
public class BambooSteamerScreen extends HandledScreen<BambooSteamerScreenHandler> {
    private static final Identifier TEXTURE_1 = Identifier.of(Bakingdelight.MOD_ID,
            "textures/gui/bamboo_steamer_gui.png");
    private static final Identifier TEXTURE_2 = Identifier.of(Bakingdelight.MOD_ID,
            "textures/gui/bamboo_steamer2_gui.png");
    private static final Identifier TEXTURE_3 = Identifier.of(Bakingdelight.MOD_ID,
            "textures/gui/bamboo_steamer3_gui.png");
    private static final Identifier TEXTURE_4 = Identifier.of(Bakingdelight.MOD_ID,
