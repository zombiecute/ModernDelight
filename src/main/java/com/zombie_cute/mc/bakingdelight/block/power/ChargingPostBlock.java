...
public class ChargingPostBlock extends BlockWithEntity {
    ...
    public void appendTooltip(ItemStack stack, @Nullable BlockView world, List<Text> tooltip, TooltipContext options) {
        if(Screen.hasShiftDown()){
            ...
            tooltip.add(Text.translatable(MiscUtil.CHARGING_POST_1).formatted(Formatting.GOLD));
            tooltip.add(Text.translatable(MiscUtil.CHARGING_POST_2).formatted(Formatting.GOLD));
            tooltip.add(Text.translatable(MiscUtil.CHARGING_POST_3).formatted(Formatting.GOLD));
            tooltip.add(Text.translatable(MiscUtil.CHARGING_POST_4).formatted(Formatting.GOLD));
