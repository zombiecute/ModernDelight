...
public class GasCookingStoveBlock extends AbstractGasCookingStoveBlock {
    ...
    public static final MapCodec<GasCookingStoveBlock> CODEC = createCodec((s) -> new GasCookingStoveBlock());
    protected MapCodec<? extends GasCookingStoveBlock> getCodec() {
        return CODEC;
    }
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType options) {
        if(Screen.hasShiftDown()){
            ...
            tooltip.addAll(TextUtil.generateToolTip(Text.translatable(TextUtil.GAS_COOKING_STOVE)));
        }else {
