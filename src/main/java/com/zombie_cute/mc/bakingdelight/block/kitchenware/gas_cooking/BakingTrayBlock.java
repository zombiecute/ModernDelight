...
public class BakingTrayBlock extends BlockWithEntity implements Waterloggable{
    ...
    public void appendTooltip(ItemStack stack, @Nullable BlockView world, List<Text> tooltip, TooltipContext options) {
        if(Screen.hasShiftDown()){
            ...
            tooltip.add(Text.translatable(MiscUtil.BAKING_TRAY_1).formatted(Formatting.GOLD));
            tooltip.add(Text.translatable(MiscUtil.BAKING_TRAY_2).formatted(Formatting.GOLD));
            tooltip.add(Text.translatable(MiscUtil.BAKING_TRAY_3).formatted(Formatting.GOLD));
        } else {
