...
public class ModBlockEntities {
    public static final BlockEntityType<OvenBlockEntity> OVEN_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID,"oven_be"),
                    BlockEntityType.Builder.create(OvenBlockEntity::new, ModBlocks.OVEN).build());
    public static final BlockEntityType<GlassBowlBlockEntity> GLASS_BOWL_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "glass_bowl_be"),
            BlockEntityType.Builder.create(GlassBowlBlockEntity::new, ModBlocks.GLASS_BOWL).build(null)
    );
    public static final BlockEntityType<FreezerBlockEntity> FREEZER_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "freezer_be"),
            BlockEntityType.Builder.create(FreezerBlockEntity::new, ModBlocks.FREEZER).build(null)
    );
    public static final BlockEntityType<PizzaWIPBlockEntity> PIZZA_WIP_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "pizza_wip_be"),
            BlockEntityType.Builder.create(PizzaWIPBlockEntity::new, ModBlocks.PIZZA_WIP).build(null)
    );
    public static final BlockEntityType<BakingTrayBlockEntity> BAKING_TRAY_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "baking_tray_be"),
            BlockEntityType.Builder.create(BakingTrayBlockEntity::new, ModBlocks.BAKING_TRAY).build(null)
    );
    public static final BlockEntityType<AdvanceFurnaceBlockEntity> ADVANCE_FURNACE_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "advance_furnace_block_entity"),
            BlockEntityType.Builder.create(AdvanceFurnaceBlockEntity::new, ModBlocks.ADVANCE_FURNACE).build(null)
    );;
    public static final BlockEntityType<WoodenBasinBlockEntity> WOODEN_BASIN_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID,"wooden_basin_block_be"),
            BlockEntityType.Builder.create(WoodenBasinBlockEntity::new, ModBlocks.WOODEN_BASIN).build(null)
    );
    public static final BlockEntityType<GasCanisterBlockEntity> GAS_CANISTER_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID,"gas_canister_block_be"),
            BlockEntityType.Builder.create(GasCanisterBlockEntity::new, ModBlocks.GAS_CANISTER).build(null)
    );
    public static final BlockEntityType<BiogasDigesterControllerBlockEntity> BIOGAS_DIGESTER_CONTROLLER_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID,"biogas_digester_controller_block_be"),
            BlockEntityType.Builder.create(BiogasDigesterControllerBlockEntity::new, ModBlocks.BIOGAS_DIGESTER_CONTROLLER).build(null)
    );
    public static final BlockEntityType<BiogasDigesterIOBlockEntity> BIOGAS_DIGESTER_IO_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID,"biogas_digester_io_block_be"),
            BlockEntityType.Builder.create(BiogasDigesterIOBlockEntity::new, ModBlocks.BIOGAS_DIGESTER_IO).build(null)
    );
    public static final BlockEntityType<BurningGasCookingStoveBlockEntity> BURNING_GAS_COOKING_STOVE_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID,"gas_cooking_stove_block_be"),
            BlockEntityType.Builder.create(BurningGasCookingStoveBlockEntity::new, ModBlocks.BURNING_GAS_COOKING_STOVE).build(null)
    );
    public static final BlockEntityType<DeepFryerBlockEntity> DEEP_FRYER_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID,"deep_fryer_block_be"),
            BlockEntityType.Builder.create(DeepFryerBlockEntity::new, ModBlocks.DEEP_FRYER).build(null)
    );
    public static final BlockEntityType<KitchenUtensilHolderBlockEntity> KITCHEN_UTENSIL_HOLDER_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "kitchen_utensil_holder_be"),
            BlockEntityType.Builder.create(KitchenUtensilHolderBlockEntity::new, ModBlocks.KITCHEN_UTENSIL_HOLDER).build(null)
    );
    public static final BlockEntityType<CuisineTableBlockEntity> CUISINE_TABLE_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "cuisine_table_be"),
            BlockEntityType.Builder.create(CuisineTableBlockEntity::new, ModBlocks.CUISINE_TABLE).build(null)
    );
    public static final BlockEntityType<RawPizzaBlockEntity> RAW_PIZZA_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "raw_pizza_be"),
            BlockEntityType.Builder.create(RawPizzaBlockEntity::new, ModBlocks.RAW_PIZZA).build(null)
    );
    public static final BlockEntityType<PizzaBlockEntity> PIZZA_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "pizza_be"),
            BlockEntityType.Builder.create(PizzaBlockEntity::new, ModBlocks.PIZZA).build(null)
    );
    public static final BlockEntityType<CabinetBlockEntity> CABINET_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "cabinet_be"),
            BlockEntityType.Builder.create(CabinetBlockEntity::new, ModBlocks.ANDESITE_CABINET,
    ...
    public static final BlockEntityType<PhotovoltaicGeneratorBlockEntity> PHOTOVOLTAIC_GENERATOR_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "photovoltaic_generator_be"),
            BlockEntityType.Builder.create(PhotovoltaicGeneratorBlockEntity::new, ModBlocks.PHOTOVOLTAIC_GENERATOR).build(null)
    );
    public static final BlockEntityType<ACDCConverterBlockEntity> AC_DC_CONVERTER_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "ac_dc_converter_be"),
            BlockEntityType.Builder.create(ACDCConverterBlockEntity::new, ModBlocks.AC_DC_CONVERTER).build(null)
    );
    public static final BlockEntityType<FanBladeBlockEntity> FAN_BLADE_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "fan_blade_be"),
            BlockEntityType.Builder.create(FanBladeBlockEntity::new, ModBlocks.FAN_BLADE).build(null)
    );
    public static final BlockEntityType<WindTurbineControllerBlockEntity> WIND_TURBINE_CONTROLLER_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "wind_turbine_controller_be"),
            BlockEntityType.Builder.create(WindTurbineControllerBlockEntity::new, ModBlocks.WIND_TURBINE_CONTROLLER).build(null)
    );
    public static final BlockEntityType<BatteryBlockEntity> BATTERY_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "battery_be"),
            BlockEntityType.Builder.create(BatteryBlockEntity::new,
    ...
    public static final BlockEntityType<SterlingEngineBlockEntity> STERLING_ENGINE_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "sterling_engine_be"),
            BlockEntityType.Builder.create(SterlingEngineBlockEntity::new, ModBlocks.STERLING_ENGINE).build(null)
    );
    public static final BlockEntityType<FaradayGeneratorBlockEntity> FARADAY_GENERATOR_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "faraday_generator_be"),
            BlockEntityType.Builder.create(FaradayGeneratorBlockEntity::new, ModBlocks.FARADAY_GENERATOR).build(null)
    );
    public static final BlockEntityType<TeslaCoilBlockEntity> TESLA_COIL_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "tesla_coil_be"),
            BlockEntityType.Builder.create(TeslaCoilBlockEntity::new, ModBlocks.TESLA_COIL).build(null)
    );
    public static final BlockEntityType<ElectriciansDeskBlockEntity> ELECTRICIANS_DESK_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "electricians_desk_be"),
            BlockEntityType.Builder.create(ElectriciansDeskBlockEntity::new, ModBlocks.ELECTRICIANS_DESK).build(null)
    );
    public static final BlockEntityType<BambooGrateBlockEntity> BAMBOO_GRATE_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "bamboo_grate_be"),
            BlockEntityType.Builder.create(BambooGrateBlockEntity::new, ModBlocks.BAMBOO_GRATE).build(null)
    );
    public static final BlockEntityType<ElectricSteamerBlockEntity> ELECTRIC_STEAMER_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "electric_steamer_be"),
            BlockEntityType.Builder.create(ElectricSteamerBlockEntity::new, ModBlocks.ELECTRIC_STEAMER).build(null)
    );
    public static final BlockEntityType<IceCreamMakerBlockEntity> ICE_CREAM_MAKER_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "ice_cream_maker_be"),
            BlockEntityType.Builder.create(IceCreamMakerBlockEntity::new, ModBlocks.ICE_CREAM_MAKER).build(null)
    );
    public static final BlockEntityType<FishAndChipsBlockEntity> FISH_AND_CHIPS_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "fish_and_chips_be"),
            BlockEntityType.Builder.create(FishAndChipsBlockEntity::new, ModBlocks.FISH_AND_CHIPS).build(null)
    );
    public static final BlockEntityType<ChargingPostBlockEntity> CHARGING_POST_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "charging_post_be"),
            BlockEntityType.Builder.create(ChargingPostBlockEntity::new, ModBlocks.CHARGING_POST).build(null)
    );
    public static final BlockEntityType<JuiceExtractorBlockEntity> JUICE_EXTRACTOR_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "juice_extractor_be"),
            BlockEntityType.Builder.create(JuiceExtractorBlockEntity::new, ModBlocks.JUICE_EXTRACTOR).build(null)
    );
    public static final BlockEntityType<DeepFryBasketBlockEntity> DEEP_FRY_BASKET_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "deep_fry_basket_be"),
            BlockEntityType.Builder.create(DeepFryBasketBlockEntity::new, ModBlocks.DEEP_FRY_BASKET).build(null)
    );
    public static final BlockEntityType<WoodenPlateBlockEntity> WOODEN_PLATE_BLOCK_ENTITY = Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "wooden_plate_be"),
            BlockEntityType.Builder.create(WoodenPlateBlockEntity::new, ModBlocks.WOODEN_PLATE).build(null)
    );
