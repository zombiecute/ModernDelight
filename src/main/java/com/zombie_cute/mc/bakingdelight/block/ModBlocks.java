...
import com.zombie_cute.mc.bakingdelight.block.crops.WildCropBlock;
...
public class ModBlocks {
    ...
    public static final Block MASHED_POTATO_BLOCK = registerBlock("mashed_potato_block",
            new MashedPotatoBlock(AbstractBlock.Settings.copy(Blocks.DIRT).sounds(BlockSoundGroup.SAND)
    ...
    public static final Block GLASS_BOWL = registerBlock("glass_bowl",
            new GlassBowlBlock(AbstractBlock.Settings.copy(Blocks.GLASS).hardness(0)
                    .mapColor(MapColor.WHITE).nonOpaque()));
    public static final Block BLACK_PEPPER_CROP = registerBlockWithoutItem("black_pepper_crop",
            new BlackPepperCropBlock(AbstractBlock.Settings.copy(Blocks.POTATOES)));
    public static final Block OVEN = registerBlock("oven",
            new OvenBlock(AbstractBlock.Settings.copy(Blocks.BRICKS)
                    .luminance(state -> state.get(OvenBlock.OVEN_BURNING) ? 15 : 0)));
    public static final Block FREEZER = registerBlock("freezer",
            new FreezerBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).nonOpaque()));
    public static final Block WHEAT_DOUGH = registerBlockWithoutItem("wheat_dough",
            new WheatDoughBlock(AbstractBlock.Settings.copy(Blocks.REPEATER).burnable().sounds(BlockSoundGroup.HONEY)
    ...
    public static final Block CREAM_FLUID_BLOCK = registerBlockWithoutItem("cream_fluid",
            new FluidBlock(ModFluid.STILL_CREAM,AbstractBlock.Settings.copy(Blocks.WATER)));
    ...
    public static final Block VEGETABLE_OIL_FLUID_BLOCK = registerBlockWithoutItem("vegetable_oil_fluid",
            new FluidBlock(ModFluid.STILL_VEGETABLE_OIL,AbstractBlock.Settings.copy(Blocks.WATER)));
    ...
    public static final Block KITCHEN_UTENSIL_HOLDER = registerBlock("kitchen_utensil_holder",
            new KitchenUtensilHolderBlock(AbstractBlock.Settings.copy(Blocks.OAK_PLANKS).hardness(0)
    ...
    public static final Block DEEPSLATE_CABINET = registerBlock("deepslate_cabinet",new CabinetBlock(
            AbstractBlock.Settings.copy(Blocks.DEEPSLATE).nonOpaque()
    ));
    ...
    public static final Block BASALT_CABINET = registerBlock("basalt_cabinet",new CabinetBlock(
            AbstractBlock.Settings.copy(Blocks.BASALT).nonOpaque()
    ));
    public static final Block OBSIDIAN_CABINET = registerBlock("obsidian_cabinet",new CabinetBlock(
            AbstractBlock.Settings.copy(Blocks.OBSIDIAN).nonOpaque()
    ));
    ...
    public static final Block SIMPLE_BATTERY = registerBlockWithoutItem("simple_battery", new SimpleBatteryBlock(AbstractBlock.Settings.copy(Blocks.IRON_BARS)));
    public static final Block INTERMEDIATE_BATTERY = registerBlockWithoutItem("intermediate_battery", new IntermediateBatteryBlock(AbstractBlock.Settings.copy(Blocks.IRON_BARS)));
    public static final Block ADVANCE_BATTERY = registerBlockWithoutItem("advance_battery", new AdvanceBatteryBlock(AbstractBlock.Settings.copy(Blocks.IRON_BARS)));
    public static final Block DIMENSION_BATTERY = registerBlockWithoutItem("dimension_battery", new DimensionBatteryBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).luminance((s) -> 8)));
    ...
    public static final Block WILD_PEPPER_CROP = registerBlock("wild_pepper_crop", new WildCropBlock(
            AbstractBlock.Settings.copy(Blocks.DANDELION).nonOpaque().noCollision()
    ));
    ...
    public static final Block WILD_GARLIC = registerBlock("wild_garlic", new WildCropBlock(
            AbstractBlock.Settings.copy(Blocks.DANDELION).nonOpaque().noCollision()
    ));
    ...
    public static final Block LIQUEFIED_BIOGAS_FLUID_BLOCK = registerBlockWithoutItem("liquefied_biogas_fluid",
            new FluidBlock(ModFluid.STILL_LIQUEFIED_BIOGAS,AbstractBlock.Settings.copy(Blocks.WATER)));
    ...
    public static final Block SWEENTENED_WATER_FLUID_BLOCK = registerBlockWithoutItem("sweetened_water_fluid",
            new FluidBlock(ModFluid.STILL_SWEETENED_WATER,AbstractBlock.Settings.copy(Blocks.WATER)));
    // Block Items
    public static final BlockItem FISH_AND_CHIPS_ITEM = Registry.register(Registries.ITEM,Identifier.of(ModernDelightMain.MOD_ID,"fish_and_chips"),
            new BlockItem(FISH_AND_CHIPS,new Item.Settings().maxCount(16).food(
                    new FoodComponent.Builder().nutrition(20).saturationModifier(0.6f).build()
            )){
                @Override
    ...
    public static final BlockItem ICE_CREAM_MAKER_ITEM = Registry.register(Registries.ITEM,Identifier.of(ModernDelightMain.MOD_ID,"ice_cream_maker"),
            new IceCreamMakerBlockItem());
    public static final BlockItem STERLING_ENGINE_ITEM = Registry.register(Registries.ITEM,Identifier.of(ModernDelightMain.MOD_ID,"sterling_engine"),
            new SterlingEngineBlockItem());
    public static final BlockItem FAN_BLADE_ITEM = Registry.register(Registries.ITEM,Identifier.of(ModernDelightMain.MOD_ID,"fan_blade"),
            new BlockItem(FAN_BLADE,new Item.Settings().maxCount(16)));
    public static final BlockItem SIMPLE_BATTERY_ITEM = Registry.register(Registries.ITEM,Identifier.of(ModernDelightMain.MOD_ID,"simple_battery"),
            new BatteryBlockItem((AbstractBatteryBlock) SIMPLE_BATTERY));
    public static final BlockItem INTERMEDIATE_BATTERY_ITEM = Registry.register(Registries.ITEM,Identifier.of(ModernDelightMain.MOD_ID,"intermediate_battery"),
            new BatteryBlockItem((AbstractBatteryBlock) INTERMEDIATE_BATTERY));
    public static final BlockItem ADVANCE_BATTERY_ITEM = Registry.register(Registries.ITEM,Identifier.of(ModernDelightMain.MOD_ID,"advance_battery"),
            new BatteryBlockItem((AbstractBatteryBlock) ADVANCE_BATTERY));
    public static final BlockItem DIMENSION_BATTERY_ITEM = Registry.register(Registries.ITEM,Identifier.of(ModernDelightMain.MOD_ID,"dimension_battery"),
            new BatteryBlockItem((AbstractBatteryBlock) DIMENSION_BATTERY));
    public static final BlockItem DEEP_FRY_BASKET_ITEM = Registry.register(Registries.ITEM,Identifier.of(ModernDelightMain.MOD_ID,"deep_fry_basket"),
            new BlockItem(DEEP_FRY_BASKET,new Item.Settings().maxCount(1)));
    public static final BlockItem GAS_CANISTER_ITEM = Registry.register(Registries.ITEM,Identifier.of(ModernDelightMain.MOD_ID,"gas_canister"),
            new GasCanisterBlockItem());
    public static final BlockItem PIZZA_ITEM = Registry.register(Registries.ITEM, Identifier.of(ModernDelightMain.MOD_ID, "pizza"),
            new BlockItem(PIZZA, new Item.Settings().maxCount(1)));
    public static final BlockItem RAW_PIZZA_ITEM = Registry.register(Registries.ITEM, Identifier.of(ModernDelightMain.MOD_ID, "raw_pizza"),
            new BlockItem(RAW_PIZZA, new Item.Settings()
                    .food(new FoodComponent.Builder().nutrition(8).saturationModifier(0.1f)
                            .statusEffect(new StatusEffectInstance(StatusEffects.HUNGER,200,0),0.4f).build()).maxCount(1)));
    public static final BlockItem PIZZA_WIP_ITEM = Registry.register(Registries.ITEM, Identifier.of(ModernDelightMain.MOD_ID, "pizza_wip"),
            new BlockItem(PIZZA_WIP, new Item.Settings()
                    .food(new FoodComponent.Builder().nutrition(5).saturationModifier(0.1f)
                            .statusEffect(new StatusEffectInstance(StatusEffects.HUNGER,200,0),0.3f).build()).maxCount(1)));
    public static final BlockItem WHEAT_DOUGH_ITEM = Registry.register(Registries.ITEM, Identifier.of(ModernDelightMain.MOD_ID, "wheat_dough"),
            new BlockItem(WHEAT_DOUGH, new Item.Settings()
    ...
    public static final BlockItem JUICE_EXTRACTOR_ITEM = Registry.register(Registries.ITEM, Identifier.of(ModernDelightMain.MOD_ID, "juice_extractor"),
            new JuiceExtractorBlockItem());
    public static final BlockItem CHERRY_MILK_TEA_ITEM = Registry.register(Registries.ITEM, Identifier.of(ModernDelightMain.MOD_ID, "cherry_milk_tea"),
            new GlassCupOfTeaBlockItem(CHERRY_MILK_TEA));
    public static final BlockItem ROSE_ICE_TEA_TEA_ITEM = Registry.register(Registries.ITEM, Identifier.of(ModernDelightMain.MOD_ID, "rose_ice_tea"),
            new GlassCupOfTeaBlockItem(ROSE_ICE_TEA));
    public static final BlockItem STEAMED_PUMPKIN_ITEM = Registry.register(Registries.ITEM, Identifier.of(ModernDelightMain.MOD_ID, "steamed_pumpkin"),
            new BlockItem(STEAMED_PUMPKIN, new Item.Settings().maxCount(16).recipeRemainder(WOODEN_PLATE.asItem())));

    private static Block registerBlockWithoutItem(String name,Block block){
        return Registry.register(Registries.BLOCK,Identifier.of(ModernDelightMain.MOD_ID,name),block);
    }
    ...
    private static void registerBlockItem(String name, Block block){
        Registry.register(Registries.ITEM, Identifier.of(ModernDelightMain.MOD_ID, name),
