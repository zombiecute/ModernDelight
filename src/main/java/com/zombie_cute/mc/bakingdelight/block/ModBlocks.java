...
public class ModBlocks {
    ...
    public static final Block DIMENSION_BATTERY = registerBlockWithoutItem("dimension_battery", new DimensionBatteryBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).luminance((state)-> 8)));
    ...
    // Block Items
    public static final BlockItem FISH_AND_CHIPS_ITEM = Registry.register(Registries.ITEM,Identifier.of(Bakingdelight.MOD_ID,"fish_and_chips"),
    ...
    public static final BlockItem ICE_CREAM_MAKER_ITEM = Registry.register(Registries.ITEM,Identifier.of(Bakingdelight.MOD_ID,"ice_cream_maker"),
            new IceCreamMakerBlockItem());
    public static final BlockItem STERLING_ENGINE_ITEM = Registry.register(Registries.ITEM,Identifier.of(Bakingdelight.MOD_ID,"sterling_engine"),
            new BlockItem(STERLING_ENGINE,new Item.Settings().maxCount(16)));
    public static final BlockItem FAN_BLADE_ITEM = Registry.register(Registries.ITEM,Identifier.of(Bakingdelight.MOD_ID,"fan_blade"),
            new BlockItem(FAN_BLADE,new Item.Settings().maxCount(16)));

    public static final BlockItem SIMPLE_BATTERY_ITEM = Registry.register(Registries.ITEM,Identifier.of(Bakingdelight.MOD_ID,"simple_battery"),
            new BlockItem(SIMPLE_BATTERY,new Item.Settings().maxCount(1)));
    public static final BlockItem INTERMEDIATE_BATTERY_ITEM = Registry.register(Registries.ITEM,Identifier.of(Bakingdelight.MOD_ID,"intermediate_battery"),
            new BlockItem(INTERMEDIATE_BATTERY,new Item.Settings().maxCount(1)));
    public static final BlockItem ADVANCE_BATTERY_ITEM = Registry.register(Registries.ITEM,Identifier.of(Bakingdelight.MOD_ID,"advance_battery"),
            new BlockItem(ADVANCE_BATTERY,new Item.Settings().maxCount(1)));
    public static final BlockItem DIMENSION_BATTERY_ITEM = Registry.register(Registries.ITEM,Identifier.of(Bakingdelight.MOD_ID,"dimension_battery"),
            new BlockItem(DIMENSION_BATTERY,new Item.Settings().maxCount(1)));

    public static final BlockItem DEEP_FRY_BASKET_ITEM = Registry.register(Registries.ITEM,Identifier.of(Bakingdelight.MOD_ID,"deep_fry_basket"),
            new BlockItem(DEEP_FRY_BASKET,new Item.Settings().maxCount(1)));
    public static final BlockItem GAS_CANISTER_ITEM = Registry.register(Registries.ITEM,Identifier.of(Bakingdelight.MOD_ID,"gas_canister"),
            new BlockItem(GAS_CANISTER,new Item.Settings().maxCount(1)));
    public static final BlockItem PIZZA_ITEM = Registry.register(Registries.ITEM, Identifier.of(Bakingdelight.MOD_ID, "pizza"),
            new BlockItem(PIZZA, new Item.Settings().maxCount(1)));
    public static final BlockItem RAW_PIZZA_ITEM = Registry.register(Registries.ITEM, Identifier.of(Bakingdelight.MOD_ID, "raw_pizza"),
    ...
    public static final BlockItem PIZZA_WIP_ITEM = Registry.register(Registries.ITEM, Identifier.of(Bakingdelight.MOD_ID, "pizza_wip"),
    ...
    public static final BlockItem WHEAT_DOUGH_ITEM = Registry.register(Registries.ITEM, Identifier.of(Bakingdelight.MOD_ID, "wheat_dough"),
    ...
    private static Block registerBlockWithoutItem(String name,Block block){
        return Registry.register(Registries.BLOCK,Identifier.of(Bakingdelight.MOD_ID,name),block);
    }
    ...
    private static Item registerBlockItem(String name, Block block){
        return Registry.register(Registries.ITEM, Identifier.of(Bakingdelight.MOD_ID, name),
