...
public class ACDCConverterBlock extends BlockWithEntity {
    ...
    @Override
    protected MapCodec<? extends ACDCConverterBlock> getCodec() {
        return CODEC;
    }
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    private static final VoxelShape TYPE_X = Block.createCuboidShape(2,0,0,14,14,16);
    private static final VoxelShape TYPE_Z = Block.createCuboidShape(0,0,2,16,14,14);
    @Override
