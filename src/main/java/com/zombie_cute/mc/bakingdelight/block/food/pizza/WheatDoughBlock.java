...
import static com.zombie_cute.mc.bakingdelight.block.food.pizza.PizzaWIPBlockEntity.NEED_CHEESE;
...
public class WheatDoughBlock extends Block {
    ...
    private boolean isKneadingStick(@NotNull Item item) {
        ...
        for (RegistryEntry<Item> registryEntry : Registries.ITEM.iterateEntries(TagKeys.KNEADING_STICKS)) {
