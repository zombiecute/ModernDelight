...
public class FaradayGeneratorBlock extends BlockWithEntity {
    ...
    public void appendTooltip(ItemStack stack, @Nullable BlockView world, List<Text> tooltip, TooltipContext options) {
        if(Screen.hasShiftDown()){
            ...
            tooltip.add(Text.translatable(MiscUtil.FARADAY_GENERATOR_1).formatted(Formatting.GOLD));
            tooltip.add(Text.translatable(MiscUtil.FARADAY_GENERATOR_2).formatted(Formatting.GOLD));
            tooltip.add(Text.translatable(MiscUtil.FARADAY_GENERATOR_3).formatted(Formatting.GOLD));
