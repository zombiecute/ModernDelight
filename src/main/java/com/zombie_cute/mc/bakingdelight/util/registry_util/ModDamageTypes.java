...
public class ModDamageTypes {
    public static final RegistryKey<DamageType> ELECTROSHOCK = RegistryKey.of(
            RegistryKeys.DAMAGE_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "electroshock"));
    public static final RegistryKey<DamageType> TURNED_TO_ASHES = RegistryKey.of(
            RegistryKeys.DAMAGE_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "turned_to_ashes"));
    public static final RegistryKey<DamageType> SCALDED = RegistryKey.of(
            RegistryKeys.DAMAGE_TYPE, Identifier.of(ModernDelightMain.MOD_ID, "scalded"));
