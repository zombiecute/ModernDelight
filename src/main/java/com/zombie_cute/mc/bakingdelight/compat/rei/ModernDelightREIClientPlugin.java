...
public class ModernDelightREIClientPlugin implements REIClientPlugin {
    @Override
    ...
    public void registerDisplays(DisplayRegistry registry) {
        ...
        registry.registerRecipeFiller(SqueezeRecipe.class,SqueezeRecipe.Type.INSTANCE,(entry) -> new WoodenBasinDisplay(entry.value()));
        ...
        registry.registerRecipeFiller(JuiceExtractingRecipe.class, JuiceExtractingRecipe.Type.INSTANCE, (entry) -> new JuiceExtractingDisplay(entry.value()));
        registry.add(new InstantNoodlesMakingDisplay());
        registry.registerRecipeFiller(GrindingRecipe.class, GrindingRecipe.Type.INSTANCE, (entry) -> new GrindingDisplay(entry.value()));
    }
