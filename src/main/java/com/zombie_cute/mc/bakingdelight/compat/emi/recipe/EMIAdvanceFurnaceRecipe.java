...
public class EMIAdvanceFurnaceRecipe implements EmiRecipe {
    ...
    public static final EmiRecipeCategory CATEGORY
            = new EmiRecipeCategory(Identifier.of(ModernDelightMain.MOD_ID, "advance_furnace_transforming"), WORKSTATION);
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addSlot(output.getFirst(), 101, 18).recipeContext(this);
