...
public class JuiceExtractingDisplay extends BasicDisplay {
    public JuiceExtractingDisplay(JuiceExtractingRecipe recipe){
    ...
    public CategoryIdentifier<?> getCategoryIdentifier() {
        return JuiceExtractingCategory.JUICE_EXTRACTING;
    }
}
