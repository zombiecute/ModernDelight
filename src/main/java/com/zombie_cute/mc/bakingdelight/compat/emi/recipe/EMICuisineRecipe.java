...
public class EMICuisineRecipe implements EmiRecipe {
    public static final Identifier TEXTURE = new Identifier(ModernDelightMain.MOD_ID, "textures/gui/compats/cuisine.png");
    public static final EmiStack WORKSTATION = EmiStack.of(ModBlocks.CUISINE_TABLE);
    public static final EmiRecipeCategory CATEGORY
            = new EmiRecipeCategory(new Identifier(ModernDelightMain.MOD_ID, "cuisine"), WORKSTATION);
