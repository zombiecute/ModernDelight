...
public class EMIWhiskingRecipe implements EmiRecipe {
    public static final Identifier TEXTURE = new Identifier(Bakingdelight.MOD_ID, "textures/gui/compats/glass_bowl.png");
    public static final EmiStack WORKSTATION = EmiStack.of(ModBlocks.GLASS_BOWL);
    public static final EmiRecipeCategory CATEGORY
            = new EmiRecipeCategory(new Identifier(Bakingdelight.MOD_ID, "whisking"), WORKSTATION);
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addSlot(EmiIngredient.of(ModTagKeys.WHISKS,1),27,5);
