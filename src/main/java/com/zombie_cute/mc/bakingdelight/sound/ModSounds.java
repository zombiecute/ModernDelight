...
public class ModSounds {
    ...
    public static final SoundEvent BLOCK_STERLING_ENGINE_START = registerSound("block_sterling_engine_start");
    public static final SoundEvent BLOCK_STERLING_ENGINE_STOP = registerSound("block_sterling_engine_stop");
    public static final SoundEvent BLOCK_TESLA_COIL = registerSound("block_tesla_coil");
    public static final SoundEvent BLOCK_JUICE_EXTRACTOR_WORKING = registerSound("block_juice_extractor_working");
    public static final SoundEvent BLOCK_JUICE_EXTRACTOR_SCREAM = registerSound("block_juice_extractor_scream");
    public static final SoundEvent BLOCK_JUICE_EXTRACTOR_STOP = registerSound("block_juice_extractor_stop");
